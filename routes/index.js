...
router.get('/', function (req, res, next) {
  res.render('index', { title: 'Deodorant App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Deodorant App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Deodorant App Login', user: req.user });
});
